  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-blue-200 text-slate-900" dir="rtl">
      ...
      <nav className="flex items-center justify-between p-6 max-w-7xl mx-auto">
        ...
        <button 
          onClick={() => window.location.href = 'https://souqbtp.ma/login'}
      ...
      <section className="max-w-7xl mx-auto px-6 pt-12 pb-24 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button 
            onClick={() => window.location.href = 'https://souqbtp.ma/register'}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-slate-800 rounded-3xl p-8 border border-slate-700 flex flex-col">
              ...
              <button 
                onClick={() => window.location.href = 'https://wa.me/212700715399'} 
                className="w-full py-3 rounded-xl bg-slate-700 hover:bg-slate-600 font-bold transition-colors"
              >
                تواصل معنا
              </button>
