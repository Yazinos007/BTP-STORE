...
const EmpireLanding = () => {
  return (
    <div className="supplier-landing-page" dir="rtl" style={{ fontFamily: "'Tajawal', sans-serif", backgroundColor: '#0F172A', color: '#F8FAFC', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <style>{`
        ...
        .hero-section::before {
          ...
          width: 60vw; height: 60vw; background: radial-gradient(circle, rgba(26, 82, 118, 0.4) 0%, rgba(15, 23, 42, 0) 70%);
          z-index: 0; pointer-events: none;
        }

        .hero-section::after {
          content: ''; position: absolute; bottom: -10%; right: -10%;
          width: 40vw; height: 40vw; background: radial-gradient(circle, rgba(243, 156, 18, 0.15) 0%, rgba(15, 23, 42, 0) 70%);
          z-index: 0; pointer-events: none;
        }

        .hero-content { position: relative; z-index: 1; max-width: 800px; margin: 0 auto; }

        .hook-text { color: var(--accent-orange); font-size: 1.2rem; font-weight: 800; margin-bottom: 20px; text-shadow: 0 2px 4px rgba(0,0,0,0.5); letter-spacing: 0.5px; }
        ...
        .urgency-box { margin-top: 25px; padding: 15px; background: rgba(243, 156, 18, 0.1); border: 1px dashed var(--accent-orange); border-radius: 10px; display: inline-block; max-width: 650px; text-align: center; }
        .urgency-text { font-size: 1.1rem; color: var(--accent-orange); font-weight: 700; margin: 0; line-height: 1.6; }
      ...
      <section className="cta-container">
        <a href="https://wa.me/212700715399?text=مرحباً،%20أنا%20مهتم%20بمشروع%20الإمبراطورية%20وباقة%20Enterprise%20السنوية" className="btn-whatsapp" target="_blank" rel="noreferrer">
            ...
            مرحباً، أنا مهتم بمشروع الإمبراطورية وباقة Enterprise السنوية
        </a>
        
        {/* 🚀 الحل التسويقي لمعضلة الندرة للمورد */}
        <div className="urgency-box">
            <p className="urgency-text">⏳ تنبيه: الاشتراك في الباقة متاح للجميع، لكن <strong>الهدايا الذهبية وحقيبة الـ VIP Kit</strong> متوفرة فقط لأول 3 موردين يشتركون سنوياً في كل مدينة. ما تضيعش هديتك!</p>
        </div>
      </section>
