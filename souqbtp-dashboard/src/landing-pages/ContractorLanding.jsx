    ...
    <div className="contractor-landing-page" dir="rtl" style={{ fontFamily: "'Tajawal', sans-serif", backgroundColor: '#0f172a', color: '#f8fafc', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <style>{`
        ...
        .hero::before {
            ...
            width: 70vw; height: 70vw; background: radial-gradient(circle, rgba(249, 115, 22, 0.15) 0%, rgba(15, 23, 42, 0) 70%);
        ...
        @media (max-width: 768px) {
            .main-title { font-size: 2.2rem; } .sub-title { font-size: 1.1rem; }
            .enterprise-card { padding: 40px 20px 30px; } .card-title { font-size: 2rem; }
            .section-title { font-size: 2rem; } .btn-whatsapp { padding: 18px 30px; font-size: 1.2rem; width: 100%; }
        }
      `}</style>
        ...
        <div className="hero-content">
          ...
          <div className="enterprise-card-wrapper">
            ...
            <div className="enterprise-card">
              <div className="badge">
                <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" strokeWidth="2.5" fill="none"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path><path d="m9 12 2 2 4-4"></path></svg>
